...
<script>
    ...
    function handleDelete(id){
        ...
        layer.confirm('确认要删除吗?', {icon: 3, title:'提示'}, function(index){
            ...
            $.ajax({
                url:"<%=GlobalValue.PROJECT_PATH%>admin/removeAdmin?id="+id,
                type:"get",
    ...
    function handleEdit(id){
        ...
        layer.open({
            ...
            content: ['<%=GlobalValue.PROJECT_PATH%>layer/admin_edit.jsp?id='+id,'no'],
            // 区域 宽 高
            area: ['500px', '300px'],
            end:()=>{
                tableIns.reload();
    ...
    layui.use('table',()=>{
        ...
        tableIns = table.render({
            ...
            limits:[1,10,30],
            // 请求地址
            url:'<%=GlobalValue.PROJECT_PATH%>admin/getAdminsList',
            // 请求方式
            method:'post',
            // 内容类型
